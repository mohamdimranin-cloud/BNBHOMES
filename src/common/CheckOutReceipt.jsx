...
import { extractDateTime, getToday, numberToWords } from '../constants/Functions';
import { forwardRef } from 'react';

const CheckOutReceipt = forwardRef(({ formData }, ref) => {
  return (
    <div className='p-2 w-[800px]' ref={ref}>
      <div className='flex-row border-2 border-blue-800 rounded'>
        <div>
          ...
          <DialogTitle align='center' component="h2" fontWeight={900} fontSize={24}>Guest Receipt - Checkin</DialogTitle>
        </div>
        <div className='flex -mt-1 border-t border-b p-1 items-center justify-between'>
          ...
          <div className='mr-2'>
            ...
            <div className='flex'>
              ...
              <span>{formData.bookingRefNum !== "" ? formData.bookingRefNum : "null"}</span>
            </div>
            <div className='flex'>
              <span>Date: &nbsp;</span>
              <span>{getToday()}</span>
        ...
        <div className='border-b'>
          <table className='my-5 p-5'>
            ...
            <tr>
              ...
              <td colSpan={3}>{formData.extraBed}</td>
            </tr>
            <tr>
              <td colSpan={5}><br /></td>
            </tr>
            <tr>
              ...
              <td colSpan={3}>{formData.guestName}</td>
            </tr>
            <tr>
              <td className='px-4'>Mobile Number</td>
              <td colSpan={3}>{formData.guestMobileNumber}</td>
            </tr>
            <tr>
              <td className='px-4'>WhatsApp Number</td>
              <td colSpan={3}>{formData.guestWhatsappNumber}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colSpan={3}>{formData.numOfAdults + formData.numOfChildren}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              {
                // todo: change to balance payment
              }
              <td colSpan={3}>{formData.bikeCarNumber}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colSpan={3}>{formData.paymentMethod}</td>
            </tr>
          </table>

          <div className='w-full text-right px-3 text-black'>
            <span>Amount Received from: </span>
        ...
        <div className='mt-5 mb-1 w-full text-right text-black pr-5'>
